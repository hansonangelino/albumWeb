...
*/
var jAlbumGlobals1679470599244 = (function () {
...
var jAlbumInject = (function () {
	...
	inj('<div id="Responsive' + jAlbumGlobals1679470599244.uniqueId + '" class="jAlbum Responsive">'); // Responsive id surrounds all code of the body of the skin
	...
	inj('<script src="' + jAlbumGlobals1679470599244.jAlbumURL + 'res/libs/jquery-2.1.4.min.js"></script>'); // embets jQuery library
	...
	inj('<script src="' + jAlbumGlobals1679470599244.jAlbumURL + 'res/libs/jquery.mobile-1.4.5.min.js"></script>'); // includes jQuery Mobile
	inj('<script src="' + jAlbumGlobals1679470599244.jAlbumURL + 'res/libs/jquery.touchswipe.min.js"></script>'); // jQuery touchswipe plugin
	inj('<script src="' + jAlbumGlobals1679470599244.jAlbumURL + 'main.js" type="text/javascript"></script>'); // includes skin controller
	...
	function injLink(path, rel){
		...
		elem.href = jAlbumGlobals1679470599244.jAlbumURL + path;
		elem.rel = rel;
...
*/
window._jaWidgetBarColor = jAlbumGlobals1679470599244.widgetColor;

if(!document.getElementById('non-embedded')){ // check if embedded
	window._jaUrl = jAlbumGlobals1679470599244.jAlbumURL;
	_jaSkin = "Responsive";
_jaStyle = "dark.css";
_jaVersion = "30.1";
